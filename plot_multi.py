...
# 	data_6 = table[:,87] # chan 21, abs 48
	...
	fig, ax = plt.subplots()
	ax.plot(bins, data_0, linewidth=1, label="Chan 0")
	ax.plot(bins, data_1, linewidth=1, label="Chan 1") #label="2.5 keV")
	ax.plot(bins, data_15, linewidth=1, label="Chan 3")
	ax.plot(bins, data_2, linewidth=1, label="Chan 6") #label="5 keV")
	ax.plot(bins, data_25, linewidth=1, label="Chan 9")
	ax.plot(bins, data_3, linewidth=1, label="Chan 11") #label="7 keV")
	ax.plot(bins, data_4, linewidth=1, label="Chan 14") #label="10 keV")
	ax.plot(bins, data_45, linewidth=1, label="Chan 16")
	ax.plot(bins, data_5, linewidth=1, label="Chan 18") #label="13 keV")
	ax.plot(bins, data_55, linewidth=1, label="Chan 19")
	ax.plot(bins, data_6, linewidth=1, label="Chan 21") #label="20 keV")
	ax.plot(bins, data_65, linewidth=1, label="Chan 23")
	ax.plot(bins, data_7, linewidth=1, label="Chan 25")
