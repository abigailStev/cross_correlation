...
# in_file="$home_dir/Reduced_data/$propID/$obsID/GTId_eventlist_1.dat"
# in_file="$home_dir/Reduced_data/$propID/$obsID/GTId_eventlist_1.fits"
in_file="$home_dir/Dropbox/Research/sample_data/GTId_eventlist_1.dat"
...
# else
# 	echo "$in_file does not exist. CCF.py was not run."
# fi
